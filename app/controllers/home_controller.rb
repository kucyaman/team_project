class HomeController < ApplicationController
    ...
    def top
        ...
        @user_log_ranks = User.joins(:curriculum_logs).select("users.*, count(curriculum_logs.id) as curriculum_logs_count").group("users.id").order("curriculum_logs_count DESC")
